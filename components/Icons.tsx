...
export const Logo = ({ className = "w-10 h-10" }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Outer Eye Shape */}
    <path 
      d="M10 50 C 10 20, 90 20, 90 50 C 90 80, 10 80, 10 50 M 15 50 C 15 75, 85 75, 85 50 C 85 25, 15 25, 15 50" 
      fill="url(#logo-gradient)" 
    />
    {/* Inner Hexagonal Pupil Pattern */}
    <path 
      d="M50 35 L63 42.5 L63 57.5 L50 65 L37 57.5 L37 42.5 Z" 
      fill="url(#logo-gradient)"
    />
    <circle cx="50" cy="50" r="22" fill="none" stroke="url(#logo-gradient)" strokeWidth="3" strokeDasharray="5,3" />
  </svg>
);
...
export const IconDollar = ({ className }: { className?: string }) => (
...
export const IconFile = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
);

export const IconHistory = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline><path d="M3.3 7a9 9 0 1 1 0 10"></path><polyline points="2 6 3.4 7 4.6 5.8"></polyline></svg>
);
